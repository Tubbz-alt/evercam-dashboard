...
getSnapmailHtml = (snapMail, index) ->
  ...
  html += '        <div class="card-padding"><div class="hash-label snapmail-title"><a data-toggle="modal" data-target="#snapmail-form" class="tools-link edit-snapmail" data-val="' + snapMail.id + '" title="' + camera_names + '">' + camera_names + '</a><span class="line-end"></span></div>'
  html +='         <div class="camera-time"><span class="spn-label"><i class="far fa-clock font-16"></i></span><div class="div-snapmail-values">' + snapMail.notify_time + ' (' + snapMail.timezone + ')</div><div class="clear-f"></div></div>'
  html +='         <div class="camera-email"><span class="spn-label"><i class="fas fa-users"></i></span><div class="div-snapmail-values snapmail-title" title="' + recipients + '">' + recipients + '<span class="line-end"></span></div><div class="clear-f"></div></div>'
  html +='         <div class="camera-days"><span class="spn-label margin-top-5"><i class="far fa-calendar-alt font-16"></i></span><div id="divDays' + snapMail.id + '" class="div-snapmail-values"> <span class="days-unchek Monday">M</span><span class="days-unchek Tuesday">T</span><span class="days-unchek Wednesday">W</span><span class="days-unchek Thursday">T</span><span class="days-unchek Friday">F</span><span class="days-unchek Saturday">S</span><span class="days-unchek Sunday">S</span> </div><div class="clear-f"></div></div>'
  html +='         <div class="snapmail-edit"><img src="/assets/edit-icon-blue.svg" class="edit-icon-archive main-color icon-font plus-btn tools-link edit-snapmail" title="Edit" data-toggle="modal" data-target="#snapmail-form" data-val="' + snapMail.id + '" data-action="e"></div>'
...
initializeiCheck = ->
  $(".snapmail-checkbox input[type='checkbox']").iCheck
